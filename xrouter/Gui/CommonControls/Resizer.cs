...
namespace XRouter.Gui.CommonControls
{
    ...
    public class Resizer : ContentControl
    {
        ...
        public static readonly DependencyProperty CanResizeWidthProperty = DependencyProperty.Register("CanResizeWidthProperty",
            typeof(bool),
            typeof(Resizer),
            new FrameworkPropertyMetadata(true));

        public static readonly DependencyProperty CanResizeHeightProperty = DependencyProperty.Register("CanResizeHeightProperty",
            typeof(bool),
            typeof(Resizer),
            new FrameworkPropertyMetadata(true));
        ...
        public bool CanResizeWidth
        {
            get
            {
                return (bool)GetValue(CanResizeWidthProperty);
            }
            set
            {
                SetValue(CanResizeWidthProperty, value);
            }
        }
        ...
        public bool CanResizeHeight
        {
            get
            {
                return (bool)GetValue(CanResizeHeightProperty);
            }
            set
            {
                SetValue(CanResizeHeightProperty, value);
            }
        }
