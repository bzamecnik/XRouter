...
namespace SchematronVal.Resources
{
        ...
        public static XDocument SchemaPhaseA
        {
            get
            {
                lock (typeof(Provider))
                {
                    ...
                    {
                        schemaPhaseA = LoadXmlDocument("SchematronVal.Resources.schema_phaseA.xml");
                    }
                }
        ...
        public static XDocument SchemaPhaseB
        {
            get
            {
                lock (typeof(Provider))
                {
                    ...
                    {
                        schemaPhaseB = LoadXmlDocument("SchematronVal.Resources.schema_phaseB.xml");
                    }
                }
        ...
        public static XDocument SchemaPhaseC
        {
            get
            {
                lock (typeof(Provider))
                {
                    ...
                    {
                        schemaPhaseC = LoadXmlDocument("SchematronVal.Resources.schema_phaseC.xml");
                    }
                }
