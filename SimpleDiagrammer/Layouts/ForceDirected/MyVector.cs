...
namespace SimpleDiagrammer.Layouts.ForceDirected
{
    ...
    public struct MyVector
    {
        ...
        public MyVector(double magnitude, double direction)
        {
        ...
        public static MyVector operator +(MyVector a, MyVector b)
        {
            ...
            return new MyVector(magnitude, direction);
        }
        ...
        public static MyVector operator *(MyVector vector, double multiplier)
        {
            // only magnitude is affected by scalar multiplication
            return new MyVector(vector.Magnitude * multiplier, vector.Direction);
        }
