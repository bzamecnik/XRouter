...
namespace XRouter.Experiments_MC.Simulations.Tests
{
    class TestSimulation3 : Simulation
    {
            ...
            : base("MC_TestSimulation3")
        {
            ...
            var messageFlowProcessor = new BroadcastingMessageFlowProcessor_v2("Broadcaster", 2, 2, managementProxy);
            

            var sender1_wfp = new Connector_v1(sender1, messageFlowProcessor.ConnectableInputPoints[0]);
            var sender2_wfp = new Connector_v1(sender2, messageFlowProcessor.ConnectableInputPoints[1]);
            var mfp_display1 = new Connector_v1(messageFlowProcessor.ConnectableOutputPoints[0], display1);
            var mfp_display2 = new Connector_v1(messageFlowProcessor.ConnectableOutputPoints[1], display2);
